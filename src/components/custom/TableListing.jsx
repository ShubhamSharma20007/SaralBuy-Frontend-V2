  ...
  return (
    <div className="space-y-5">
      ...
      <div className={`flex ${title ? 'justify-between  gap-4' : 'justify-end'} items-center`}>
        {title && (
          <p
            className={`font-bold text-xl whitespace-nowrap   tracking-tight text-${colorPalette}-600  tracking-tight`}
          >
            {title}
          </p>
        )}
        {filters && (
          <div className="flex items-center gap-4">
            ...
            <Button
              ...
              onClick={() => setSorting([{ id: 'your_budget', desc: false }])}
            >
            ...
            <Button
              ...
              onClick={() => setSorting([{ id: 'your_budget', desc: true }])}
            >
      ...
      <div
        className={`overflow-hidden max-h-[600px] rounded-md ${colorPalette ? `bg-${colorPalette}-50  rounded-lg` : ''}`}
      >
        <Table>
          <TableHeader>
            ...
            {isPending && isPending() ? (
              ...
              <TableRow>
                <TableCell
                  ...
                  className={`${filters ? 'h-[285px]' : 'h-[310px]'}  text-center`}
                >
